...
/* Another method of declaring function "getValueAsStr":
    getValueAsStr = () => valueEl.textContent.split(',').join('');
 */
...
const updateTime = () => {
    ...
    /*if i do not want it to run 0 - 24 hours
...
setInterval(updateTime, 1000);  //1000 millisecond
updateTime();